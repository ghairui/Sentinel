...
/**
 * 该处理参考https://blog.csdn.net/zhuocailing3390/article/details/123257774
 *
 */
@RestController
...
public class DegradeControllerV2 {
    ...
    public Result<List<DegradeRuleEntity>> apiQueryMachineRules(String app, String ip, Integer port) {
        logger.debug("/v2/degrade/rules.json收到参数【app】:{},【ip】:{},【port】:{}",app,ip,port);
        ...
        try {
            String ruleStr = ruleProvider.getRules(app + NacosConfigUtil.DEGRADE_DATA_ID_POSTFIX, app);
            logger.debug("/v2/degrade/rules通过ruleNacosProvider获取规则:{}", ruleStr);
    ...
    private boolean publishRules(String app, String ip, Integer port) {
        try{
            ...
            rulePublisher.publish(app + NacosConfigUtil.DEGRADE_DATA_ID_POSTFIX,app, ruleStr);
            return true;
        } catch (Exception e) {
            e.printStackTrace();
        }
